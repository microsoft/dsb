...
define IMID=range(random(1, 1000,uniform), 20);
...
define DISCOUNT = RANGE(RANDOM (0, 100, UNIFORM), 15);
...
from
   ...
   ,date_dim
where
(i_manufact_id BETWEEN [IMID.begin] and [IMID.end]
or i_category IN ('[CATEGORY.1]', '[CATEGORY.2]', '[CATEGORY.3]'))
and i_item_sk = ws_item_sk
and d_date between '[WSDATE]' and
        cast('[WSDATE]' as date) + interval '90 day'
