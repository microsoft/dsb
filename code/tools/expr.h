...
#define EXPR_FL_SUFFIX_MASK	(EXPR_FL_LIST|EXPR_FL_RANGE|EXPR_FL_ULIST|EXPR_FL_SLIST|EXPR_FL_SULIST)	/* substitution that allow suffixes */
...
void SwapBuf(Expr_Val_t *pBuf, int p1, int p2);
void SortBufStr(Expr_Val_t *pBuf, int n);
void SortBufInt(Expr_Val_t *pBuf, int n);
