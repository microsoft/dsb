...
{"item",           mk_w_item,{ pr_w_item, ld_w_item }, validateSCD, post_w_item },
{"customer_address",mk_w_customer_address, {pr_w_customer_address, ld_w_customer_address}, validateGeneric, post_w_customer_address},
{"customer_demographics",mk_w_customer_demographics, {pr_w_customer_demographics, ld_w_customer_demographics}, validateGeneric, post_w_customer_demographics},
{"household_demographics",mk_w_household_demographics,{ pr_w_household_demographics, ld_w_household_demographics }, validateGeneric, post_w_household_demographics },
{"customer",       mk_w_customer,{ pr_w_customer, ld_w_customer }, validateGeneric, post_w_customer },
...
{"store_sales",    mk_w_store_sales, {pr_w_store_sales, ld_w_store_sales}, vld_w_store_sales, post_w_store_sales },
