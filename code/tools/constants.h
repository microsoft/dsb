 ...
 ***/
#define CR_RETURN_PCT	15	/* percentage of catalog sales that are returned */
 ...
 ***/
#define SR_RETURN_PCT	25	/* percentage of store sales that are returned */
 ...
 ***/
#define WR_RETURN_PCT	20	/* percentage of web sales that are returned */
