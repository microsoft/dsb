...
#define ITEM	1
#define CUSTOMER_ADDRESS	2
#define CUSTOMER_DEMOGRAPHICS	3
#define HOUSEHOLD_DEMOGRAPHICS	4
#define CUSTOMER	5
#define CATALOG_PAGE	6
#define CATALOG_RETURNS	7
#define CATALOG_SALES	8
#define DATE	9
#define INCOME_BAND	10
#define INVENTORY	11
#define PROMOTION	12
#define REASON	13
#define SHIP_MODE	14
